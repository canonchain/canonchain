...
namespace czr
{
	...
	{
	public:
		std::shared_ptr<czr::block> receive_action(czr::block const &, czr::uint128_union const &, bool = true);
		...
		bool receive_sync(std::shared_ptr<czr::block>, czr::uint128_t const &);
		void receive_async(std::shared_ptr<czr::block>, czr::uint128_t const &, std::function<void(std::shared_ptr<czr::block>)> const &, bool = true);
	...
	public:
		...
		bool search_pending(czr::uint256_union const &);
