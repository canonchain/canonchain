...
{
/**
 * Specialization of czr::rpc with TLS support
 */
class rpc_secure : public rpc
{
public:
	rpc_secure (boost::asio::io_service & service_a, czr::node & node_a, czr::rpc_config const & config_a);
...
/**
 * Specialization of czr::rpc_connection for establishing TLS connections.
 * Handshakes with client certificates are supported.
 */
class rpc_connection_secure : public rpc_connection
{
public:
	rpc_connection_secure (czr::node &, czr::rpc_secure &);
