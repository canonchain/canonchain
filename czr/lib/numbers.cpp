...
thread_local CryptoPP::AutoSeededRandomPool czr::random_pool;
...
bool czr::uint512_union::operator== (czr::uint512_union const & other_a) const
{
	return bytes == other_a.bytes;
}
...
czr::uint512_union & czr::uint512_union::operator^= (czr::uint512_union const & other_a)
{
